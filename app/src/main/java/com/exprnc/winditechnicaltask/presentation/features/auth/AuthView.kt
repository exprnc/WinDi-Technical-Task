            ...
            Column(
                ...
                CountryPickerOutlinedTextField(
                    ...
                    onMobileNumberChange = { phoneNumber ->
                        ...
                        if(filteredPhone.length > 30) {
                            onIntent(AuthIntent.OnPhoneNumberTooLong)
                        } else {
                            val maxPhoneLength = 30 - viewState.country.countryPhoneNumberCode.length
                            onIntent(AuthIntent.OnPhoneInput(field = filteredPhone.take(maxPhoneLength)))
                        }
                    },
